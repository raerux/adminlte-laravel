                ...
                <div class="col-lg-7 connectedSortable">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h3 class="card-title">Valor das vendas</h3>
                        </div>
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <div class="direct-chat-text">
                                        Esse template realmente é gratuito?
                                    </div>
                                    <!-- /.direct-chat-text -->
                                </div>
                                <!-- /.direct-chat-msg -->
                                ...
                                <div class="direct-chat-msg end">
                                    ...
                                    />
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">Você tem que acreditar!</div>
                                    <!-- /.direct-chat-text -->
                                </div>
                                <!-- /.direct-chat-msg -->
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                        Trabalhando com AdminLTE em um ótimo app! Quer se juntar?
                                    </div>
                                    <!-- /.direct-chat-text -->
                                </div>
                                <!-- /.direct-chat-msg -->
